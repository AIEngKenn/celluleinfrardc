    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: "Ponts", value: "bridges" },
          { title: "Eau et assainissement", value: "water" },
          { title: "Électricité", value: "electricity" },
          { title: "Écoles", value: "schools" },
          { title: "Hôpitaux", value: "hospitals" },
          { title: "Ports", value: "ports" },
          { title: "Aéroports", value: "airports" },
          { title: "Chemins de fer", value: "railways" },
          { title: "Télécommunications", value: "telecommunications" },
