          ...
          >
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span
                  className={cn(
                    "font-normal leading-tight text-gray-500 transition-all duration-300",
                    compact ? "text-[0.625rem]" : "text-[0.7rem] lg:text-xs"
                  )}
                >
                        ...
                        <AnimatePresence>
                          {activeDropdown === item.href && (
                            <motion.ul
                              ...
                              className="absolute left-1/2 top-full z-50 mt-1 min-w-[240px] -translate-x-1/2 overflow-hidden rounded-xl border border-gray-100 bg-white p-1.5 shadow-xl shadow-gray-900/8"
                              role="menu"
                              onMouseEnter={() => handleDropdownEnter(item.href)}
                              onMouseLeave={handleDropdownLeave}
                            >
            ...
            <>
              ...
              >
                ...
                <div className="border-t border-gray-100 px-5 py-4">
                  ...
                  <div className="mt-4 flex h-1 w-full overflow-hidden rounded-full" aria-hidden="true">
                    <span className="flex-1 bg-[#007FFF]" />
                    <span className="flex-1 bg-[#F7D618]" />
                    <span className="flex-1 bg-[#CE1021]" />
                  </div>
